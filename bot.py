...
#Создаем кнопки
button_registr= KeyboardButton (text="Регистрация в Telegram-боте")
...
#Чтобы запрашивать информацию и ждать ответа,
#нужно использовать состояния.
...
@dp.message(F.text == "Регистрация в Telegram-боте")
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/c11a4c67472d87d0bceca255/latest/USD"
    try:
